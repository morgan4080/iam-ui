          ...
          <div class="flex-1 min-w-0">
              ...
              >
                <div>
                  ...
                  <p class="mt-2 text-sm text-gray-500">
                    <a
                      href="#"
                      class="font-medium text-gray-900 lowercase"
                      >{{ organisation }}</a
                    >
                  </p>
                ...
                <div class="mt-4 flex space-x-3 md:mt-0">
                  ...
                  <button
                    @click="
                      $router.push(`/users/${route.params.id}/assign-roles`)
                    "
                    type="button"
                  ...
                  >
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="ml-2 -mr-0.5 h-4 w-4 text-green-400"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      stroke-width="2"
            ...
            <div class="ml-3 mt-4 text-sm block">
              <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                ...
                <div class="sm:col-span-1">
                  <dt class="text-sm font-medium text-gray-500">USSD Status</dt>
                  <dd class="mt-1 text-sm text-gray-900">
                    {{
                ...
                <div class="sm:col-span-1">
                  ...
                  <dd class="mt-1 text-sm text-gray-900">
                    <a
                      class="text-blue-400"
                      href="#"
                      >Status: {{ userData.pinStatus }}</a
                    >
                    <br />
                    <a
                      class="text-blue-400"
                      href="#"
                      >Remaining Attempts: {{ userData.pinAttempts }}</a
                    >
                  </dd>
                </div>
              </dl>
