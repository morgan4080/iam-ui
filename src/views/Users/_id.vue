          ...
          <div class="ml-3 mt-4 text-sm block ">
            <div class="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
              ...
              <div class="mt-4 flex space-x-3 md:mt-0">
                ...
                <button @click="$router.push(`/users/${route.params.id}/change-password`)" type="button" class="inline-flex justify-center px-3 py-2 border border-indigo-300 leading-4 shadow-sm text-xs font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Change Password
                ...
                <button v-if="userData.isEnabled" @click="enableUser" type="button" class="group inline-flex justify-center px-3 py-2 border border-red-300 leading-4 shadow-sm text-xs font-medium rounded-md text-red-700 bg-red-200 hover:bg-red-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                  Disable
                ...
                <button v-else type="button" class="group inline-flex justify-center px-3 py-2 border border-red-300 leading-4 shadow-sm text-xs font-medium rounded-md text-red-700 bg-red-200 hover:bg-red-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                  Enable
                  <svg xmlns="http://www.w3.org/2000/svg" @click="disableUser" class="ml-2 -mr-0.5 h-4 w-4 text-red-700 group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                  </svg>
                </button>
              </div>
