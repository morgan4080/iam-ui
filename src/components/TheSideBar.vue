    ...
    <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 pb-4 bg-white overflow-y-auto">
      ...
      <div class="flex-grow flex flex-col">
        ...
        <nav class="flex-1 px-2 space-y-1 bg-white" aria-label="Sidebar">
          ...
          <div class="space-y-1">
            <button type="button" class="bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900 group w-full flex items-center pr-2 py-2 text-left text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" aria-controls="sub-menu-1" @click="open0 = !open0" aria-expanded="false">
          ...
          <div class="space-y-1 hidden">
            <button type="button" class="bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900 group w-full flex items-center pr-2 py-2 text-left text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" aria-controls="sub-menu-1" @click="open = !open" aria-expanded="false">
