...
<template>
  <div
    :class="{
      'transition duration-500 ease-in-out w-64': setWidth,
      'transition duration-500 ease-in-out w-0': !setWidth,
    }"
    class="flex flex-col transform bg-white"
  >
    <div
      class="ml-4 mt-3 border-r text-base relative font-bold tracking-tight text-gray-900"
    >
      <div v-if="setWidth">
      ...
      <div class="flex-grow flex flex-col">
        ...
        >
          <div>
            <router-link
              to="/dashboard"
              class="text-gray-900 group w-full flex items-center pl-7 pr-2 py-2 text-sm font-medium rounded-md hover:bg-gray-50 hover:text-gray-900"
            >
              Dashboard
            </router-link>
          </div>
