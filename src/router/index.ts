...
const routes = [
    ...
    {path:'/admin/users/:id', name: 'UserView', component: () => import("@/views/Users/_id.vue")},
    {path:'/admin/users/:id/edit', name: 'UsersEdit', component: () => import("@/views/Users/Edit.vue")},
    ...
    {path:'/admin/profiles/:id', name: 'ProfileView', component: () => import("@/views/Users/_id.vue")},
    {path:'/admin/profiles/:id/edit', name: 'ProfilesEdit', component: () => import("@/views/Users/Edit.vue")},
